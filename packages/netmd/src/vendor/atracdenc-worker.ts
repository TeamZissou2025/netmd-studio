/**
 * Vendored from Web MiniDisc Pro (asivery/webminidisc) — src/services/audio/atracdenc-worker.ts
 *
 * NO MODIFICATIONS to logic. Only getPublicPathFor adjusted to use /wasm/ prefix.
 *
 * This file serves dual purpose:
 * - When imported as a module, provides the AtracdencProcess class
 * - When loaded as a Worker, sets up the onmessage handler for WASM encoding
 */

/* eslint no-restricted-globals: 0 */
// @ts-nocheck — This file runs in both main thread and Worker contexts.
// TypeScript cannot type-check the dual-context Worker pattern correctly.
